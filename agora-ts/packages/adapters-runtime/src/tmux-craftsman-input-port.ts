...
import type { CraftsmanInputPort, CraftsmanInputPortExecution, InteractiveRuntimePort } from '@agora-ts/core';

const TMUX_ADAPTERS = new Set(['codex', 'claude', 'gemini']);

export class TmuxCraftsmanInputPort implements CraftsmanInputPort {
  constructor(private readonly runtime: Pick<InteractiveRuntimePort, 'sendText' | 'sendKeys' | 'submitChoice'>) {}
