import type {
  CraftsmanDispatchRequest,
  CraftsmanDispatchResult,
  InteractiveRuntimeDoctorPane as TmuxDoctorPane,
  InteractiveRuntimeIdentityUpdate as TmuxRuntimeIdentityUpdate,
  InteractiveRuntimePort,
  InteractiveRuntimeResumeResult as TmuxResumeResult,
  InteractiveRuntimeStartResult as TmuxStartResult,
  RuntimeIdentitySource as TmuxIdentitySource,
} from '@agora-ts/core';
import type { ProcessCraftsmanAdapter } from '@agora-ts/adapters-craftsman';
import type { GeminiSessionIdentity } from './gemini-session-discovery.js';
...
export class TmuxRuntimeService implements InteractiveRuntimePort {
  private readonly registry: TmuxPaneRegistry;
  private readonly adapters: Record<string, ProcessCraftsmanAdapter>;
  private readonly geminiSessionDiscovery: { resolveIdentity(input: { workspaceRoot: string }): GeminiSessionIdentity | null } | undefined;
