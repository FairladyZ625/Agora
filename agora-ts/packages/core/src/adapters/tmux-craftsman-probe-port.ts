...
import type { CraftsmanExecutionProbePort, CraftsmanProbePortExecution } from '../craftsman-probe-port.js';
...
export class TmuxCraftsmanProbePort implements CraftsmanExecutionProbePort {
  constructor(private readonly runtime: Pick<TmuxRuntimeService, 'doctor' | 'tail'>) {}
