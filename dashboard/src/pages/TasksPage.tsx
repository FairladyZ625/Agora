          ...
          <div className="task-pane__filters">
            <div className="task-toolbar__group">
              <div className="workbench-toolbar__filter-anchor">
                <button
                  type="button"
                  className={filterOpen ? 'button-secondary task-toolbar__button task-toolbar__button--active' : 'button-secondary task-toolbar__button'}
              ...
              {activeFilterCount > 0 ? (
                <span className="task-toolbar__status">
